            ...
            <div class="container-main single-main">
              <div class="col-md-12">
                <div class="block-main mb-30 d-flex flex-column align-items-center">
                  <img src={imagePath} class="img-responsive border rounded-lg mb-4 m-auto" style="height: 600px; width: auto; left: 50%; max-width: 100%; border: 2px solid #000;" alt="SVM Based Classifier for Detection of DDoS in IoT">
                  ...
                  <div class="content-main single-post padDiv text-center">
                    ...
                    <br>
                    <br>
                    <p class="mb-30 text-justify mx-36">The research scope of Distributed Denial of Service (DDoS) cyber-attacks are expansive as DDoS attacks are simple to implement and often result in huge service disruptions. Despite the implementation of several standard defense mechanisms, the attackers still manage to bring the system down. The impact of a DDoS attack on the Internet of Things (IoT) is more severe due to its resource-constraint nature. Existing DDoS attacks are designed to concentrate on exploiting one resource. However, the combination of multiple attacks will have the ability to exploit multiple resources, hence doing more damage to the resources, especially to the CPU computation power.<br>
